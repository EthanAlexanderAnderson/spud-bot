def dreamhelp(msgh):
    ...
    if len(msgh) == 1:
        ...
        if msgh[1].capitalize() == "Commands":
            ...
            outh += "- **Info:**\n"
            outh += "-- dreamcount (dc)\n"
            outh += "-- dreamsend (ds) [ID]\n"
            outh += "-- dreamname (dn) {name}\n"
            outh += "-- dreammentions (dm) [key]\n"
            outh += "-- dreamdifficulty (dd) {graph}\n"
            outh += "-- dreamprofile (profile) {name}\n"
            outh += "-- dreamleaderboard (dlb)\n"
            outh += "-- dreamhelp (dh) {topic}\n"
            outh += "- **Functions:**\n"
            outh += "-- dreamundo (du)\n"
            outh += "-- dreamreset\n"
            outh += "(alias) [required] {optional}"
